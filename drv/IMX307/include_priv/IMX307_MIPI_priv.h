...
/*
#ifndef _IMX307_PRIV_H
#define _IMX307_PRIV_H
...
#define IMX307_CHIP_ID_HIGH_BYTE            (0x3004) // r -
#define IMX307_CHIP_ID_LOW_BYTE          	(0x301F) // r -

#define IMX307_CHIP_ID_HIGH_BYTE_DEFAULT    (0x10) // r -
#define IMX307_CHIP_ID_LOW_BYTE_DEFAULT     (0x01) // r -

#define IMX307_MODE_SELECT  				(0x3000)

#define IMX307_SOFTWARE_RST                 (0x3003) // rw - Bit[7:1]not used  Bit[0]software_reset

typedef struct IMX307_VcmInfo_s                 /* ddl@rock-chips.com: v0.3.0 */
{
